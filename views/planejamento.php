...
<form>
        ...
        <section class="flex">
            ...
            <div class="bloco laranja full cem">
                ...
                <label>Rádio:<input type="text" name="radio"></label>
                <label>Internet:<input type="text" name="internet"></label>
                <label>TV:<input type="text" name="tv"></label>
                <label>Outros:<input type="text" name="outros"></label>
            </div>
        </section>
